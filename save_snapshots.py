"""
    Os arquivos salvos sao em ".jpg", e na pasta onde esta o programa, ja pronto para serem utilzados na calibraçao

    Para um bom resultado na calibraçao recomendo o uso de 20 capturas, fotos que apresentam distorçao de movimento e foco ruim devem ser removidas!

Botoes:
    q           - quit
    espaço      - salvar frame atual

Inspirado no codigo de "Tiziano Fiorenzani"
