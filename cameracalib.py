"""
    Codigo para calibaçao

    Crie uma pasta e deixe todas as capturas em ".jpg" e dentro dela execute esse codigo

    Adicione o numero de linhas e colunas do tabuleiro, a dimençao do mesmo

    Adicione o endereço e execute precionando enter, verificando cada foto
...
workingFolder   = '/home/tonim/Área de Trabalho/Calibraçao/'
imageType       = 'jpg'
#------------------------------------------
